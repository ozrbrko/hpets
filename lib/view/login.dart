                      ...
                      Form(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'welcome'.tr,
                              style: TextStyle(fontSize: 28, fontFamily: themeFontMedium),
                            ),
                            SizedBox(height: 40),
                            // Text("Email",style: TextStyle(fontFamily: themeFontMedium),),
                            hPetsTextFormField('email'.tr, loginInputController, 'email_required'.tr, TextInputType.text, false, "mail"),
                            SizedBox(
                              height: 12,
                            ),
                            ...
                            SizedBox(
                                ...
                                child: hPetsElevatedButton('login'.tr,
                            ...
                            SizedBox(
                              width: FrameSize.screenWidth,
                              height: FrameSize.screenHeight / 14,
                              child: hPetsElevatedButtonwithLogo('login_with_google'.tr,
                                  AppColors.redDarkThemeClr, AppColors.whiteThemeClr, 40, themeFontRegular, () async {
